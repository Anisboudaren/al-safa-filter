...
export interface Translations {
  ...
  catalogFindPerfectFilter: string
  catalogSearchVastCollection: string
  catalogFilters: string
  catalogSearch: string
  catalogFilterByOrigin: string
  catalogFilterByAlsafa: string
  catalogFilterByFiltrationSystem: string
  catalogAllOrigins: string
  catalogAllAlsafa: string
  catalogAllSystems: string
  catalogClearFilters: string
  catalogSecureSearch: string
  catalogSecureSearchDescription: string
  catalogStartSearch: string
  catalogSearchInProgress: string
  catalogProductsFound: string
  catalogPageOf: string
  catalogNoProductsFound: string
  catalogTryAdjustingSearch: string
  catalogClearAllFilters: string
...
export const translations: Record<SupportedLanguage, Translations> = {
  en: {
    ...
    // Catalog page specific
    catalogFindPerfectFilter: 'Find the Perfect Filter',
    catalogSearchVastCollection: 'Search through our vast collection of high-quality filters',
    catalogFilters: 'Filters',
    catalogSearch: 'Search',
    catalogFilterByOrigin: 'Filter by Origin',
    catalogFilterByAlsafa: 'Filter by ALSAFA',
    catalogFilterByFiltrationSystem: 'Filter by Filtration System',
    catalogAllOrigins: 'All Origins',
    catalogAllAlsafa: 'All ALSAFA',
    catalogAllSystems: 'All Systems',
    catalogClearFilters: 'Clear Filters',
    catalogSecureSearch: 'Secure Search',
    catalogSecureSearchDescription: 'Use the filters above to search for specific products. Our secure search system protects our database from automated scraping.',
    catalogStartSearch: 'Start Search',
    catalogSearchInProgress: 'Search in progress...',
    catalogProductsFound: 'products found',
    catalogPageOf: 'Page {current} of {total}',
    catalogNoProductsFound: 'No products found',
    catalogTryAdjustingSearch: 'Try adjusting your search terms or filters to find what you\'re looking for.',
    catalogClearAllFilters: 'Clear all filters',
  ...
  fr: {
    ...
    // Catalog page specific
    catalogFindPerfectFilter: 'Trouvez le filtre parfait',
    catalogSearchVastCollection: 'Recherchez parmi notre vaste collection de filtres de qualité supérieure',
    catalogFilters: 'Filtres',
    catalogSearch: 'Rechercher',
    catalogFilterByOrigin: 'Filtrer par Origine',
    catalogFilterByAlsafa: 'Filtrer par ALSAFA',
    catalogFilterByFiltrationSystem: 'Filtrer par Système de Filtration',
    catalogAllOrigins: 'Toutes les Origines',
    catalogAllAlsafa: 'Tous les ALSAFA',
    catalogAllSystems: 'Tous les Systèmes',
    catalogClearFilters: 'Effacer les filtres',
    catalogSecureSearch: 'Recherche Sécurisée',
    catalogSecureSearchDescription: 'Utilisez les filtres ci-dessus pour rechercher des produits spécifiques. Notre système de recherche sécurisé protège notre base de données contre le scraping automatisé.',
    catalogStartSearch: 'Commencer la Recherche',
    catalogSearchInProgress: 'Recherche en cours...',
    catalogProductsFound: 'produits trouvés',
    catalogPageOf: 'Page {current} sur {total}',
    catalogNoProductsFound: 'Aucun produit trouvé',
    catalogTryAdjustingSearch: 'Essayez d\'ajuster vos termes de recherche ou vos filtres pour trouver ce que vous cherchez.',
    catalogClearAllFilters: 'Effacer tous les filtres',
    catalogPrevious: 'Précédent',
    catalogNext: 'Suivant',
    catalogDimensions: 'Dimensions',
    catalogCompatible: 'Compatible',
  ...
  ar: {
    ...
    // Catalog page specific
    catalogFindPerfectFilter: 'اعثر على المرشح المثالي',
    catalogSearchVastCollection: 'ابحث في مجموعتنا الواسعة من المرشحات عالية الجودة',
    catalogFilters: 'المرشحات',
    catalogSearch: 'بحث',
    catalogFilterByOrigin: 'تصفية حسب الأصل',
    catalogFilterByAlsafa: 'تصفية حسب الصفاء',
    catalogFilterByFiltrationSystem: 'تصفية حسب نظام الترشيح',
    catalogAllOrigins: 'جميع الأصول',
    catalogAllAlsafa: 'جميع الصفاء',
    catalogAllSystems: 'جميع الأنظمة',
    catalogClearFilters: 'مسح المرشحات',
    catalogSecureSearch: 'بحث آمن',
    catalogSecureSearchDescription: 'استخدم المرشحات أعلاه للبحث عن منتجات محددة. نظام البحث الآمن لدينا يحمي قاعدة البيانات من الاستخراج التلقائي.',
    catalogStartSearch: 'ابدأ البحث',
    catalogSearchInProgress: 'البحث جاري...',
    catalogProductsFound: 'منتج موجود',
    catalogPageOf: 'صفحة {current} من {total}',
    catalogNoProductsFound: 'لم يتم العثور على منتجات',
    catalogTryAdjustingSearch: 'جرب تعديل مصطلحات البحث أو المرشحات للعثور على ما تبحث عنه.',
    catalogClearAllFilters: 'مسح جميع المرشحات',
    catalogPrevious: 'السابق',
    catalogNext: 'التالي',
    catalogDimensions: 'الأبعاد',

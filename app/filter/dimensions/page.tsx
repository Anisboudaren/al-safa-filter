                      ...
                      >
                        <Link href={`/product/${encodeURIComponent(product.ALSAFA || "unknown")}`}>
                          <Card className="h-full hover:shadow-2xl transition-all duration-300 cursor-pointer border-0 bg-white group-hover:bg-gradient-to-br group-hover:from-green-50 group-hover:to-green-100 rounded-2xl overflow-hidden">
                            ...
                            <CardContent>
                              <div className="w-full h-40 bg-white rounded-xl mb-4 overflow-hidden border border-gray-100 group-hover:border-green-200 transition-all duration-300">
                                <ProductImage
                                  ...
                                  fallbackClassName="bg-gradient-to-br from-gray-100 to-gray-200 group-hover:from-green-100 group-hover:to-green-200"
                                />
                              </div>
